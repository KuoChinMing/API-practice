...
function esLint() {
    return gulp
    .src(['src/js/hosDepBed.js', 'src/js/report.js'])
    .pipe(eslint())
    .pipe(eslint.format())
...
function watch() {
    ...
    gulp.watch(['src/js/hosDepBed.js', 'src/js/report.js'], esLint);
...
gulp.task('default', gulp.series('html', 'styles', 'scripts', 'eslint', 'watch'));
